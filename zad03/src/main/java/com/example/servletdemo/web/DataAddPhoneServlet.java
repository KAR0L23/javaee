...
@WebServlet(urlPatterns = "/data-phone")
public class DataAddPhoneServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Phone newPhone = new Phone(id, producer, productionDate, price, isReserved);

		ss.addToDatabase(newPhone);
		response.sendRedirect("all-phones");
		out.close();
	}
